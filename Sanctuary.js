...
setStyles({marginBottom:poss})
 ...
 <div style={{height:'100vh'}}>
    <div className='sanctuary' style={{height:! phone && '100%'}}>
      ...
      <h2
      style={{...style, marginBottom: `${styles.marginBottom}px`,fontSize:phone ? '3rem' : '4.6rem'}}
     >SANCTUARY</h2>
    ...
    <br/>
      ...
      <span style={{...stylee, marginTop:'5px'}}>Real-life sanctuaries for KYNs across the globe</span>
    
     <div>
     <br/>
     <h2 style={subHead}>THE CONCEPT</h2>
      <p style={{...stylee, marginTop:'5px'}}>"As terrifying and painful as reality can be, it's also... the only place that... you can get a decent
...
<h2 style={subHead}>FEASIBILITY AND SUSTAINABILITY</h2>
      <p style={{...stylee, marginTop:'5px'}}>Lots of admin, legal, and regulatory frameworks need to be tested and set up to create a
strong foundation. <br /><br/>
We will start off with just one villa, and perfect the system. <br/><br/>
...
The recurring revenue will go to maintaining these estates. <br /> <br/>
...
<h2 style={subHead}>FRIENDS AND FAMILIES</h2>
      <p style={{...stylee, marginTop:'5px',}}>What's a party if we can't enjoy it with our loved ones?<br/><br/>
...
models when we launch our first villa.<br/><br/>
